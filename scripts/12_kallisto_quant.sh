...
#SBATCH --output=logs/12_kallisto_%A_%a.log
# ═══════════════════════════════════════════════════════════════════════════════
# 12_kallisto_quant.sh — Pseudo-alignment and quantification with Kallisto
# ═══════════════════════════════════════════════════════════════════════════════
